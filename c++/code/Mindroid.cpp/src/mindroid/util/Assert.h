...
public:
    ...
    static void assertEquals(const char* message, uint16_t expected,
                             uint16_t actual);
    ...
    static void assertEquals(const char* message, uint32_t expected,
                             uint32_t actual);
    ...
    static void assertEquals(const char* message, uint64_t expected,
                             uint64_t actual);
