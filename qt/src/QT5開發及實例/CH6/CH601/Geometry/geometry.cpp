...
void Geometry::updateLabel()
{
    ...
    frameStr = tempStr1.setNum(frameGeometry().x()) + "," + tempStr2.setNum(
                   frameGeometry().y()) + "," + tempStr3.setNum(frameGeometry().width()) + "," +
    ...
    geoStr = tempStr21.setNum(geometry().x()) + "," + tempStr22.setNum(
                 geometry().y()) + "," + tempStr23.setNum(geometry().width()) + "," +
             tempStr24.setNum(geometry().height());
    geoValueLabel->setText(geoStr);

    QString wStr,
            hStr;                 //获得width()、height()函数的结果并显示
    ...
    rectStr = tempStr31.setNum(rect().x()) + "," + tempStr32.setNum(
                  rect().y()) + "," + tempStr33.setNum(/*rect().width()*/width()) + "," +
    ...
    sizeStr = tempStr41.setNum(size().width()) + "," + tempStr42.setNum(
                  size().height());
