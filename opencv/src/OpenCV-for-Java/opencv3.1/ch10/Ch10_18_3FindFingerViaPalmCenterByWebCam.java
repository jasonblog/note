            ...
            while (true) {
                ...
                if (!webcam_image.empty()) {
                    ...
                    if (R > 22) {
                        ...
                        Imgproc.circle(firstArea, new Point(centerX, centerY), R, new Scalar(255, 0,
                                       0));
                        Imgproc.line(firstArea, new Point(centerX, centerY), new Point(centerX,
                                     centerY), new Scalar(255, 0, 0), 5);

                        Imgproc.putText(firstArea, "(" + centerX + "," + centerY + ")",
                                ...
                                if (tempContour.get(index2, 0) != null) {
                                    ...
                                    for (int j = 0; j < mConvexityDefectsMatOfInt4.size().height - 1 ; j++) {
                                        ...
                                        for (int kk = 0; kk < CorrectPt1.size(); kk++) {
                                            ...
                                            Imgproc.line(firstArea, CorrectPt1.get(kk), new Point(centerX, centerY),
