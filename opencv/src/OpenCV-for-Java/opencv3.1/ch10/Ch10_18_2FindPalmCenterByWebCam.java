            ...
            while (true) {
                ...
                if (!webcam_image.empty()) {
                    ...
                    if (R > 22) {
                        ...
                        Imgproc.circle(webcam_image, new Point(centerX, centerY), R, new Scalar(255, 0,
                                       0));
                        Imgproc.line(webcam_image, new Point(centerX, centerY), new Point(centerX,
                                     centerY), new Scalar(255, 0, 0), 5);

                        Imgproc.putText(webcam_image, "(" + centerX + "," + centerY + ")",
