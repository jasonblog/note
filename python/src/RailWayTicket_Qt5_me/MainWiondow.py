...
from PyQt5.QtGui import (QFont, QPalette, QIcon, QRegExpValidator)
...
class FormWidget(QWidget):
    ...
    def __init__(self, parent):
        ...
        self.vpnBtn = QPushButton(u'開啟跳板')
        self.vpnBtn.setFixedSize(150, 40)
        self.vpnBtn.setIcon(QIcon('img/vpn.png'))
        ...
        self.lb_StartStation = QLabel(u'起站代碼')
        ...
        self.lb_EndStation = QLabel(u'到站代碼')
        ...
        self.lbPicBox = QLabel(u'驗證碼：')
        self.rightLayout.addWidget(self.lbPicBox,0,0)
        self.captchaPic = QLabel()
        ...
        self.groupBoxGoResult = QGroupBox()
        ...
        gorBox = QVBoxLayout()
        self.Go_resultMsg = QLabel()   #  用來顯示訂票結果
        ...
        # ==============設定下方log專用layout====================
        self.buttomLayout = QGridLayout()
        self.lbLog = QLabel(u'【狀態】')
        self.buttomLayout.addWidget(self.lbLog,0,0)
        self.clearBtn = QPushButton(u'清除')
    ...
    def showMessage(self,message=None):
        QMessageBox.information(self, u"提示", message if message != None else u'發生錯誤!!')

    def showAbout(self):
        QMessageBox.about(self,u"說明",
                                u"""
        <b>台鐵訂票程式</b>
    ...
    def OpenVPN(self,mainWindow):
        ...
        if 'openvpn' in path.lower():
            ...
            QMessageBox.warning(self, u"警告",u"尚未安裝OpenVPN，請參閱README.MD的說明")
    # 顯示vpn設定的對話框 並把值存檔下來
...
class VPNDialog(QDialog):
    def __init__(self, mainWindow, parent = None):
        ...
        self.TableView.setSelectionMode(QAbstractItemView.SingleSelection) #只能選一個row
        self.TableView.setSelectionBehavior(QAbstractItemView.SelectRows) #指定選擇整個row
        ...
        action_btn = buttons.addButton(QDialogButtonBox.Ok)
    ...
    def getVPNLists(mainWindow,parent = None):
        ...
        return (header,selectedValue,groupchecked, result == QDialog.Accepted)
