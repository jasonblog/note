...
public class Ch10_22_2FindSlantByBoundingRect
{
    ...
    public static void main(String[] args)
    {
        ...
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    Ch10_22_2FindSlantByBoundingRect window = new
                    Ch10_22_2FindSlantByBoundingRect();
    ...
    public Mat BoundingRect()
    {
        ...
        Mat source = Highgui.imread("C://opencv3.1//samples//IMAG0423.jpg",
        ...
        for (int i = 0; i < contours.size(); i++) {
            ...
            Core.rectangle(source, new Point(r.x, r.y), new Point(r.x + r.width,
