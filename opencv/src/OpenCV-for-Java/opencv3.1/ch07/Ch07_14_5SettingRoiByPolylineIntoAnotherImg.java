...
public class Ch07_14_5SettingRoiByPolylineIntoAnotherImg
{
    ...
    public static void main(String[] args)
    {
        ...
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    Ch07_14_5SettingRoiByPolylineIntoAnotherImg window = new
                    Ch07_14_5SettingRoiByPolylineIntoAnotherImg();
    ...
    public Mat pasteToAnother(int x, int y, Mat roi, Mat anotherImg)
    {
        ...
        Rect dstRoi = new Rect(new Point(x, y), new Point(x + getMaxX() - getMinX(),
                               y + getMaxY() - getMinY()));
