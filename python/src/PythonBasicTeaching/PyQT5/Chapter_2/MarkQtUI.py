...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.clickTestButton = QtWidgets.QPushButton(self.centralwidget)
        self.clickTestButton.setGeometry(QtCore.QRect(20, 0, 113, 32))
        self.clickTestButton.setObjectName("clickTestButton")
        self.displayListWidget = QtWidgets.QListWidget(self.centralwidget)
        self.displayListWidget.setGeometry(QtCore.QRect(50, 80, 256, 192))
