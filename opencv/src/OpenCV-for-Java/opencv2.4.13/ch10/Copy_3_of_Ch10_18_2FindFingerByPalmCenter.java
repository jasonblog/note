        ...
        if (capture.isOpened())
        {
            while (true) {
                ...
                if (!webcam_image.empty()) {
                    ...
                    Core.circle(webcam_image, new Point(centerX + 30, centerY + 90), R,
                                new Scalar(255, 255, 255));
                    Core.line(webcam_image, new Point(centerX + 30, centerY + 90),
                              new Point(centerX + 30, centerY + 90), new Scalar(255, 255, 255), 5);
