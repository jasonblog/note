...
public class Ch08_12_1LinearPolar
{
    ...
    private void initialize()
    {
        ...
        slider_flag.addChangeListener(new ChangeListener() {
            public void stateChanged(ChangeEvent arg0) {
                ...
                BufferedImage newImage = matToBufferedImage(LinearPolar(
                                             slider_maxRadius.getValue(), slider_flag.getValue()));
    ...
    public Mat LinearPolar(double maxRadius, int flag)
    {
        ...
        Mat dst = new Mat();
        Imgproc.linearPolar(source, dst, new Point(source.cols() / 2,
                            source.rows() / 2), maxRadius, tempFlag);
        return dst;
