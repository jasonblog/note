        ...
        if (capture.isOpened())
        {
            while (true) {
                ...
                if (!webcam_image.empty()) {
                    ...
                    Mat circles = new Mat();
                    Imgproc.HoughCircles(distance, circles, Imgproc.CV_HOUGH_GRADIENT, 1.0,
                                         distance.height() / 2, 300.0, 40.0, 0, 0);
                    ...
                    if (circles.cols() > 0) {
                        ...
                        for (int i = 0; i < circles.cols(); i++) {
                            ...
                            Imgproc.putText(webcam_image, "(" + center.x + "," + center.y + ")",
                    ...
                    for (int i = 0; i < fingerPoint.size(); i++) {
                        ...
                        if (i > 0) {
                            Imgproc.line(webcam_image, (Point)fingerPoint.get(i), (Point)fingerPoint.get(i),
                                         new Scalar(ran.nextInt(255) + 1, ran.nextInt(255) + 1, ran.nextInt(255) + 1),
                                         ran.nextInt(12) + 5);
                        }
