...
public:
    ...
    public:
        ...
        static sp<IOnSharedPreferenceChangeListener> asInterface(
        ...
        virtual void onTransact(int32_t what, int32_t arg1, int32_t arg2,
                                const sp<Object>& obj, const sp<Bundle>& data,
                                const sp<Object>& result) override;
        ...
        public:
            ...
            virtual void onSharedPreferenceChanged(const sp<SharedPreferences>&
                                                   sharedPreferences, const sp<String>& key) override;
