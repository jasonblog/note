...
void CSystemSignal::SetCallBackSignal(uint32 uSignal, FuncOnSignal pFunc,
                                      void* pContext, bool bLoop /* = false */)
{
...
bool CSystemSignal::RegisterToReactor()
{
    ...
    event_base_set(static_cast<event_base*>(GetReactor()->GetEventBase()),
                   &m_event);
