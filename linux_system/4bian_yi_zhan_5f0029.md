...
用memset相信也不難理解，因為這個時間混在裡面可能會看不出誤差，假定某市一季度GDP為10，二季度為15，看上去提高了50%，但是因為在計算過程中，有5份的GDP（可以想象成memset的代價）是多算在裡面的，如果扣除這5份，則實際上是從5提升了100%。因此我們在設計實驗時，需要把一些干擾項扣除，來比較，實驗的數據才具有價值。
