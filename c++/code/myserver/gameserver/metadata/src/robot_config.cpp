...
void RobotRandNameInfo::init(const std::string& country,
...
bool RobotNameCfg::randRobotNameByCountry(std::string& name,
        std::string& country)
{
    if (_randlist.empty()) {
        return false;
...
void RobotNameCfg::initList(std::vector<std::string> list, std::string& name,
                            RobotRandNameInfo& info, const std::string& country, bool bSur)
{
    std::string fullname;
