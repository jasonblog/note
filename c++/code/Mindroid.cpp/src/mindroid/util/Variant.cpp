...
size_t Variant::hashCode() const
{
    ...
    case UnsignedShort:
        return hashCode(mType, &mValue.unsignedShortValue,
                        sizeof(mValue.unsignedShortValue));

    case Int:
        return hashCode(mType, &mValue.intValue, sizeof(mValue.intValue));

    case UnsignedInt:
        return hashCode(mType, &mValue.unsignedIntValue,
                        sizeof(mValue.unsignedIntValue));

    case Long:
        return hashCode(mType, &mValue.longValue, sizeof(mValue.longValue));

    case UnsignedLong:
        return hashCode(mType, &mValue.unsignedLongValue,
                        sizeof(mValue.unsignedLongValue));
