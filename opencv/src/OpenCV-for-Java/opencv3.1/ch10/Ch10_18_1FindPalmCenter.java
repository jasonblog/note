...
public class Ch10_18_1FindPalmCenter
{
    ...
    public Mat[] FindAndDrawContours()
    {
        ...
        Imgproc.circle(source, new Point(centerX, centerY), R, new Scalar(255, 255,
                       255));
        Imgproc.line(source, new Point(centerX, centerY), new Point(centerX, centerY),
                     new Scalar(255, 255, 255), 5);
        Mat normalizeDst = new Mat();
        Core.normalize(destination1, normalizeDst, 0, 255, Core.NORM_MINMAX);
        Imgcodecs.imwrite("C://opencv3.1//samples//distanceTransform_palm2.jpg",
                          normalizeDst);
