...
int main(int argc, char** argv)
{
    ...
    virTime.it_value.tv_sec =
        100;     //設定一個很大的值，讓系統不會發生signal SIGVTALRM
    profTime.it_value.tv_sec =
        100;     //設定一個很大的值，讓系統不會發生signal SIGPROF
    ...
    signal(SIGPIPE,
           SIG_IGN);   //避免有人離開造成pipe中斷，同學們可以註解掉這段程式碼看看
