...
public class Ch11_6_1FlannBaseAndHomography
{
    ...
    public Mat Features2D()
    {
        ...
        Mat img_scene = Imgcodecs.imread(scene_filename,
        ...
        //繪出已知物的4周,使用青色
        Imgproc.line(img_matches, new Point(scene_corners.get(0, 0)),
                     new Point(scene_corners.get(1, 0)), new Scalar(0, 255, 0), 4);
        Imgproc.line(img_matches, new Point(scene_corners.get(1, 0)),
                     new Point(scene_corners.get(2, 0)), new Scalar(0, 255, 0), 4);
        Imgproc.line(img_matches, new Point(scene_corners.get(2, 0)),
                     new Point(scene_corners.get(3, 0)), new Scalar(0, 255, 0), 4);
        Imgproc.line(img_matches, new Point(scene_corners.get(3, 0)),
