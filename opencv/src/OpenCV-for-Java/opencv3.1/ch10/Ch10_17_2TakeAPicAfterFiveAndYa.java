        ...
        if (capture.isOpened())
        {
            while (isLoop) {
                ...
                if (!webcam_image.empty()) {
                            ...
                            if (tempContour.get(index2, 0) != null) {
                                ...
                                for (int j = 0; j < mConvexityDefectsMatOfInt4.size().height - 1 ; j++) {
                                    ...
                                    if (old_pt3 != null && old_pt1 != null) {
                                        ...
                                        Imgproc.putText(firstArea, getAngle(pt1, old_pt3, old_pt1) + "", old_pt3, 0,
                                                        0.3, new Scalar(0, 0, 0));//顯示指底角度
                    ...
                    count = 0;
                    //繪出手掌判斷幾個手指頭感興趣區域,矩形
                    Imgproc.rectangle(webcam_image, new Point(30, 90), new Point(300, 420),
                                      new Scalar(250, 250, 250), 3);
                    //繪出掌心置放區,以十字表示
                    Imgproc.line(webcam_image, new Point(130, 320), new Point(180, 320),
                                 new Scalar(250, 250, 250), 2); //橫
                    Imgproc.line(webcam_image, new Point(155, 295), new Point(155, 345),
                ...
                System.out.println("oldGlobalStatus=" + oldGlobalStatus + ",globalStatus=" +
                                   globalStatus);
