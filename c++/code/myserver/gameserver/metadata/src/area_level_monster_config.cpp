...
AreaLevelMonsterItem* AreaLevelMonsterConfig::getByLevelAndWeek(int level,
        int week)
{
...
std::vector<std::string> AreaLevelMonsterConfig::getByLevelAndWeek(int level,
        int week, int iMonsterId)
{
    ...
    for (auto its = ptMonsterTmp->_monster.begin();
         its != ptMonsterTmp->_monster.end(); ++its) {
