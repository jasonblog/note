...
void Bundle::putIntegerArrayList(const sp<String>& key,
...
void Bundle::putStringArrayList(const sp<String>& key,
...
uint8_t Bundle::getByte(const sp<String>& key,
...
double Bundle::getDouble(const sp<String>& key,
...
uint32_t Bundle::getUnsignedInt(const sp<String>& key,
...
int64_t Bundle::getLong(const sp<String>& key,
...
uint64_t Bundle::getUnsignedLong(const sp<String>& key,
...
sp<Object> Bundle::getObject(const sp<String>& key,
...
int16_t Bundle::getShort(const sp<String>& key,
...
uint16_t Bundle::getUnsignedShort(const sp<String>& key,
...
sp<String> Bundle::getString(const sp<String>& key,
...
sp<ArrayList<sp<String>>> Bundle::getStringArrayList(const sp<String>& key)
const
{
    sp<Variant> value = mMap->get(key);
