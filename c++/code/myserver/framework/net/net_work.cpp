...
void CNetWork::SetCallBackSignal(unsigned int uSignal, FuncOnSignal pFunc,
                                 void* pContext, bool bLoop)
{
...
void CNetWork::lcb_OnAccept(IEventReactor* pReactor, SOCKET socket,
                            sockaddr* sa)
{
...
int CNetWork::ConnectorSendData(unsigned int uId, const void* pData,
                                unsigned int uSize)
{
