...
public class Ch05_11_3ContrastUseEqualizeHistWithAddWeightedForRBG
{
    ...
    public static void main(String[] args)
    {
        ...
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    Ch05_11_3ContrastUseEqualizeHistWithAddWeightedForRBG window = new
                    Ch05_11_3ContrastUseEqualizeHistWithAddWeightedForRBG();
    ...
    private void initialize()
    {
        ...
        slider_Alpha.addChangeListener(new ChangeListener() {
            public void stateChanged(ChangeEvent arg0) {
                ...
                BufferedImage newImage = matToBufferedImage(merge(source1,
