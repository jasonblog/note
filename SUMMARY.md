...
* [Python](python/README.md)
   * [example](python/example.md)
       ...
       * [使用Pandas 函式將台灣銀行的牌告匯率存進資料庫中](python/shi_yong_pandas_han_shi_jiang_tai_wan_yin_xing_de_.md)
   ...
   * [pandas](python/pandas.md)
       ...
       * [数据操作（Pandas） 完整](python/shu_ju_cao_zuo_ff08_pandas__wan_zheng.md)
