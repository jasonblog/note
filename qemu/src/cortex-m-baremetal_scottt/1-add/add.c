/* Observe how integer addition works through a debugger */

/* Mark variables that we'll oberve through the debugger 'volatile'
 * this prevents the coimpiler from optimizing them out.
 * The idea is to use volatile variables plus a debugger
 * as an I/O device */
