...
public class Ch07_15_1ArrowedLine
{
    ...
    public Mat paint()
    {
        ...
        for (int angle = 0; angle < 360; angle += 15) {
            ...
            Imgproc.arrowedLine(source, new Point(center.x + direction.x * 0.2,
                                                  center.y + direction.y * 0.2), new Point(center.x + direction.x * 0.6,
                                                          center.y + direction.y * .6), new Scalar(255, angle, 0), thickness, lineType, 0,
